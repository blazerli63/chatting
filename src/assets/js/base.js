import $ from 'jquery';
import {getLanguageName} from './zalyKey.js';
import {getOsType} from '../sdk/zalyjsNative.js';
...
var siteConfig = {};
var enableInvitationCode=0;
var enableRealName=0;
var invitationCode='';
var allowShareRealname=0;
var preSessionId="";
var secondNum  = 120;
var isSending  = false;
var updateInvitationCodeType = "update_invitation_code";
var registerLoginName=undefined
...
// var enableInvitationCode = $(".enableInvitationCode").val();
// var enableRealName=$(".enableRealName").val();
...
var redirectUrl = 'http://10.10.28.8:9090/login';
if(page) {
